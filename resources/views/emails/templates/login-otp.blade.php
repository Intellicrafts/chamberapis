...
<div style="text-align: center; margin-bottom: 24px;">
    <h2 style="margin: 0 0 8px; font-size: 24px; color: #0f172a; font-weight: 700;">{{ $title ?? 'Login Authentication Code' }}</h2>
...
<div style="background: #ffffff; border: 1px solid #e2e8f0; border-radius: 12px; padding: 24px; margin-bottom: 24px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.05);">
    <p style="margin: 0 0 20px; font-size: 15px; line-height: 1.6; color: #334155; text-align: center;">
        You've requested to log in to your MeraBakil account securely using a One-Time Password (OTP). Please use the verification code below to complete your sign-in:
    </p>
    ...
    <div style="text-align: center; background: #fef2f2; border: 1px solid #fecaca; padding: 12px; border-radius: 6px;">
        <p style="margin: 0; font-size: 14px; color: #dc2626; font-weight: 600;">
            ⏳ This code will expire in {{ $expiresInMinutes ?? 5 }} minute(s).
        </p>
    </div>
</div>
...
<div style="background: #f1f5f9; border-radius: 8px; padding: 16px;">
    ...
    <ul style="margin: 0; padding-left: 20px; font-size: 13px; color: #475569; line-height: 1.6;">
        ...
        <li>If you did not attempt to log in, please secure your account immediately and clear your sessions.</li>
    </ul>
</div>
@endsection
